...
(async () => {
    ...
    const emotionMessages = {
        ...
        "You Look tensed try attempting quiz": "💥 Feeling stressed? Take a quick quiz and recharge!",
        "You Look bored  generate a meme,relax a bit": "😐 Bored? Meme your way to happiness!"
    };
    ...
    try {
        ...
        async function poll() {
            ...
            try {
                ...
                if (label && label !== lastShown && emotionMessages[label]) {
                    notify(emotionMessages[label]);
                    lastShown = label;
                }
            } catch (_) {
