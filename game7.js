...
`;
    ...
    matchingGameBtn.onclick = async () => {
      ...
      <div class="game-container" style="position:relative;min-height:180px;display:flex;align-items:center;justify-content:center;">
        <div style="width:100%;text-align:center;font-size:17px;padding:40px 0;">⏳ Generating matching questions for<br><b>${courseTitle}</b>…</div>
      </div>
    `;
        matchingGameOverlay.style.display = "flex";

        // 3. AI prompt for related term/definition pairs (short, compact)
        const matchPrompt = `
...
`;
        ...
        // 4. Render the game UI (CSS unchanged, compact questions)
        matchingGameOverlay.innerHTML = `
